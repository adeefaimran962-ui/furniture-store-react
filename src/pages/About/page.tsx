  ...
  return (
    <>
      ...
      <header className="bg-gradient-to-br from-[#FAF9F6] to-[#F4ECE1] text-center px-[5%] pt-[100px] pb-[80px] border-b border-[#EEEEEE] max-[768px]:px-5 max-[768px]:pt-[72px] max-[768px]:pb-14">
        <h4 className={h4Cls}>Our Story</h4>
        <h1 className={h1Cls}>
          The Art of <span className="text-[#B8860B]">Craft</span>
        </h1>
      ...
      <main className="min-h-[calc(100vh-70px)] px-[5%] py-12 max-w-[1200px] mx-auto max-[768px]:px-5 max-[768px]:py-8">
        ...
        <section className="flex flex-wrap gap-10 items-center mb-12 max-[768px]:flex-col">
          ...
          <div className="flex-[1_1_280px]">
            <h4 className={h4Cls}>Who We Are</h4>
            <h2 className={h2Cls}>Passion for Premium Living</h2>
            <p className={pCls}>
          ...
          <div className="flex-[1_1_280px] flex flex-col gap-4">
            {[
              { title: 'Sustainable Materials', desc: 'Every wood grain is FSC-certified. Every leather is ethically tanned.' },
              { title: 'Bespoke Design',        desc: 'Custom sizes, custom finishes, tailored to your exact space.' },
              { title: 'Award-Winning',         desc: 'Recognised by the European Design Awards three years running.' },
            ].map(({ title, desc }) => (
              <div key={title} className="bg-[#FAFAFA] border border-[#EEEEEE] rounded-lg p-5 border-l-4 border-l-[#B8860B]">
                ...
                <p className="text-[0.95rem] leading-[1.8] text-[#4A4A4A] m-0">{desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-[#FAFAFA] border border-[#EEEEEE] rounded-lg px-5 py-10 mb-12">
          <div className="text-center mb-4">
            <h4 className={h4Cls}>By the Numbers</h4>
            <h2 className={h2Cls}>DECORA in Figures</h2>
          </div>
          <div className="flex flex-wrap justify-center gap-10 text-center">
            {[
              ...
              <div key={label}>
                <h2 className="font-['Playfair_Display'] text-[clamp(1.3rem,3vw,2rem)] font-semibold text-[#B8860B] m-0">
                  {val}
                </h2>
                <p className="text-[0.95rem] leading-[1.8] text-[#4A4A4A] mt-1 m-0">{label}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="text-center mb-3">
          <h4 className={h4Cls}>Meet the Team</h4>
          <h2 className={h2Cls}>The People Behind DECORA</h2>
          <p className={pCls}>
            A passionate team of designers, craftspeople, and customer specialists dedicated to your experience.
          </p>
        </section>
        ...
        <div className="flex flex-wrap justify-center gap-7 my-12 mx-[5%] max-[768px]:mx-0">
          {[
            ...
            <div key={title} className="flex flex-col bg-[#FAFAFA] border border-[#EEEEEE] rounded-lg overflow-hidden flex-[1_1_260px] max-w-[320px] p-5 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_16px_40px_rgba(184,134,11,0.15)] hover:border-[#B8860B] max-[768px]:flex-[1_1_100%] max-[768px]:max-w-full">
              <h3 className={`${h3Cls} pt-[18px]`}>{title}</h3>
              <p className={`${pCls} pb-1`}>{desc}</p>
            </div>
          ))}
        </div>
      </main>
      ...
      <section className="bg-gradient-to-r from-[#8B6508] to-[#B8860B] px-[5%] py-[72px] text-center max-[768px]:px-5 max-[768px]:py-12">
        <h2 className="font-['Playfair_Display'] text-[clamp(1.3rem,3vw,2rem)] font-semibold text-white mb-2.5">
          Ready to Transform Your Space?
        </h2>
        <p className="text-[0.95rem] leading-[1.8] text-white/90 max-w-[500px] mx-auto mb-7">
